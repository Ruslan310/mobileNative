...
export default hoistStatics(
    compose(
        ...
        inject(({ transaction, viewer }, { currentTransaction, product }) => ({
            ...
            errorMessage: R.pathOr(
                false,
                ['initiateTransaction', 'error', 'message'],
                transaction,
            ),
            errorMessageEnquiry: R.pathOr(
                false,
                ['initiateOrderAfterEnquiry', 'error', 'message'],
                currentTransaction,
            ),
            ...
            onRequest: ({
                ...
                try {
                    ...
                    const {
                        ...
                        monthExpiration,
                        yearExpiration,
                    } = isUseSaveCard ? {} : payments.normalizeCardData(
                        values.cardNumber,
                    ...
                    if (currentTransaction.lastTransition === transitionStatuses.ENQUIRE) {
        ...
        withModal(
            (props) => ({
                ...
                errorMessageEnquiry: props.errorMessageEnquiry,
            }),
            RequestSentModal,
        ),
    ),
