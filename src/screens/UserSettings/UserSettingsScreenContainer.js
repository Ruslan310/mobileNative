...
import UserSettingsScreenView from "./UserSettingsScreenView";
      ...
      resendVerificationEmail: ({ sendVerifyEmail }) => async () => {
        try {
          ...
          AlertService.showAlert(
            i18n.t('userSettings.verifyEmail'),
            i18n.t('userSettings.verifyEmailSent'),
          );
        } catch (error) {
      ...
      changePassword: ({ changePassword, formRef }) => async (
        ...
        try {
          ...
          if (err.status === 403) {
            ...
            AlertService.showAlert(
              i18n.t('userSettings.errorChangeEmail'),
              i18n.t('userSettings.errorChangeEmailDetails'),
            );
          }
        }
      },
