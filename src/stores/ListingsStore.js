...
// const Location = t.model('LocationPublicData', {
//   address: t.maybe(t.string),
//   building: t.maybe(t.string),
// });

const ProductPublicData = t.model('ProductPublicData', {
  amenities: t.maybe(t.array(t.string)),
  rules: t.maybe(t.string),
  category: t.maybe(t.string),
  // location: t.optional(t.maybeNull(Location), null),
